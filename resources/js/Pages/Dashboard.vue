<template>
    <app-layout title="Dashboard">
        ...
        <div class="">
            ...
            <section class="text-gray-500 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 md:grid grid-cols-4 gap-4 md:gap-6">
                <Link :href="route('my-resume')">
                <div
                    class="hover:shadow-lg hover:bg-green-200 rounded-md bg-white shadow-md mt-2 md:mt-0 p-4 md:flex md:flex-col items-center border border-green-400">
                    <span class="text-green-400 font-bold mb-4">My Profile</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-green-400 mb-4" fill="none"
                ...
                <Link :href="route('jobs.browse')">
                <div
                    class="hover:shadow-lg hover:bg-green-200 rounded-md bg-white shadow-md mt-2 md:mt-0 p-4 md:flex md:flex-col items-center border border-green-400">
                    <span class="text-green-400 font-bold mb-4">Browse Jobs</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                        stroke="currentColor" class="h-10 w-10 text-green-400 mb-4">
                ...
                <div
                    class="hover:shadow-lg hover:bg-green-200 rounded-md bg-white shadow-md mt-2 md:mt-0 p-4 md:flex md:flex-col items-center border border-green-400">
                    <span class="text-green-400 font-bold mb-4">Update Profile</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                        stroke="currentColor" class="w-10 h-10 text-green-400 mb-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div
                    class="hover:shadow-lg hover:bg-green-200 rounded-md bg-white shadow-md mt-2 md:mt-0 p-4 md:flex md:flex-col items-center border border-green-400">
                    <span class="text-green-400 font-bold mb-4">View My Applications</span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                        stroke="currentColor" class="w-10 h-10 text-green-400 mb-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <section class="text-gray-500 max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white shadow-md p-4 hidden md:block mx-4">
                    ...
                    <ul class="md:grid grid-cols-4">
                        <li v-for="job in jobs"
                            class="highlighted text-green-500 font-bold md:col-span-1 border border-gray-300 rounded-md p-2"
                            style="width: 200px; display: block;">
                            <Link :title="job.title" :href="route('jobs.browse') + '#' + job.slug">
                            <p style="text-align: center; " class="text-sm"><strong>{{ job.title }}</strong></p>
                            </Link>
                            <div class="job-list-content">
                                <Link :title="job.title" :href="route('jobs.browse') + '#' + job.slug">
                                <img :src="job.company.logo_url" alt="Sr Financial and Business Consultants"
                                    class="bg-white"
                                    style="margin-left: auto; margin-right: auto; height: 150px; width:150px; border-radius: 5%;"
                ...
                <div class="md:hidden bg-white shadow-md rounded-md mt-2 mx-4" v-for="job in jobs">
                    ...
                    <span
                        class="text-xs inline-block py-1 px-2.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-gray-200 text-gray-700 rounded">Full-Time</span>
