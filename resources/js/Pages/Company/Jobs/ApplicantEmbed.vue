<template>
        <div class="flex flex-row gap-2 text-gray-500 p-4 px-6">
            ...
            <div class="flex flex-col flex-grow">
                ...
                <span>Applied for <strong>{{ job_title }}</strong> on August 2, 2021</span>
            </div>
            <div class="flex flex-row gap-2">
                <ApplicationStatus class="text-center h-full self-center" @change="statusUpdated" :application="application" :options="statuses"></ApplicationStatus>
<!--                <button class="bg-white border border-gray-400 rounded-md p-1 self-center">Disqualify</button>-->
                <button class="bg-green-500 text-white border border-gray-400 rounded-md p-1 self-start">Schedule Interview</button>
            </div>
        </div>
