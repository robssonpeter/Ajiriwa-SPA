                ...
                <form :action="route('job.save')" @submit.prevent="submitJob" method="post" class="text-gray-500">
                    ...
                    <section class="md:grid md:grid-cols-3 gap-4 gap-y-4">
                        <div class="input flex flex-col">
                            ...
                            <input type="text" v-model="title" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300" id="job_title" required>
                        </div>
                        <div class="input flex flex-col">
                            <label for="reports_to" class="font-bold">Reports To</label>
                            <input type="text" v-model="reports_to" id="reports_to" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300" >
                        </div>
                        <div class="input flex flex-col">
                            <label for="location" class="font-bold">Location</label>
                            <input type="text" v-model="location" id="location" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300" required>
                        </div>
                    </section>
                    ...
                    <section class="md:grid md:grid-cols-3 gap-4 gap-y-4 mt-4">
                        ...
                        <div class="input flex flex-col">
                            ...
                            <select name="category" v-model="category" id="job-category" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300">
                        ...
                        <div class="input flex flex-col">
                            ...
                            <select name="cover_letter" v-model="cover_letter" id="cover-letter" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300">
                    ...
                    <div class="grid grid-cols-3 gap-3  ">
                        ...
                        <section class="py-2 flex flex-col col-span-1">
                            ...
                            <input type="number" v-model="number_of_posts" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300" required>
                        </section>
                        ...
                        <section class="py-2 flex flex-col col-span-3" v-if="apply_method === 'url'">
                            ...
                            <input type="url" id="apply-website" v-model="application_url" placeholder="Enter Url" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300" required>
                        </section>
                        <section class="py-2 flex flex-col col-span-3" v-if="apply_method === 'email'">
                            ...
                            <input type="email" id="apply-email" v-model="application_email" placeholder="Enter your email" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300" required>
                            <div class="py-2">
                                <span class="font-bold">Application Email CC</span>
                                <section class="grid grid-cols-2 gap-2">
                                    <input type="email" @keyup="controlCC(index)" v-model="application_email_cc[index]" :placeholder="'CC '+Number(index+1)" v-for="(cc, index) in application_email_cc" class="w-full focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300">
                                    <span class="cursor-pointer mt-2 text-green-400 font-bold" v-if="allowCC" @click="addCC">Add CC</span>
                                </section>
                            </div>


                            <label for="email-subject" class="mt-2 font-bold">Email Subject Line (Optional)</label>
                            <input type="text" v-model="email_subject_line" name="subject_line" id="email-subject" placeholder="Subject Line" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300">
                        </section>

                        <section class="py-2 flex flex-col col-span-1">
                            <label for="apply-email" class="font-bold">Job Status</label>
                            <select name="apply_method" v-model="status" id="apply_method" class="focus:border-green-300 focus:ring focus:ring-green-200 focus:outline-none border-gray-300">
                                <option :value="index" v-for="(status, index) in $page.props.status">{{ status }}</option>
                            </select>
                        </section>
                        <section class="py-2 flex col-span-3">
                            <input type="checkbox" ref="add_assessments" class="self-center mr-2 accent-pink-500" name="add-assessments" id="">
                            <span class="self-center">Add add screening questions</span>
                        </section>

                        <button :disabled="saving" class="bg-green-400 hover:bg-green-500 text-white p-2 text-center self-end mb-2 justify-center">
