<template>
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        <div class="border p-6 md:max-w-4xl shadow-md rounded-lg bg-white text-gray-600 items-center text-center" v-if="$page.props.verifying">
            <span class="text-lg font-bold">Verification under way</span>
            <p>You will be notified when the process is complete.</p>
            ...
            <section class="flex flex-row pt-2">
                ...
                <small><a class="bg-green-500 hover:bg-green-400 rounded-md text-white p-1" @click.prevent="$inertia.post(route('logout')); window.reload()">Logout</a></small>
            </section>
        </div>
        <div class="border p-6 md:max-w-4xl shadow-md rounded-lg bg-white text-gray-600" v-else>
            ...
            <p>Dear user, we are committed to making sure that employers registering on our platform are legitimate. Please supply a document that proves your connection with the company you've registered with.</p>
    ...
    export default {
        ...
        methods: {
            submitVerifications(){
                ...
                /* $.ajax({
                    url: route('company.verification.save'),
                    type: 'POST',
                    data: $(this).serialize(),
