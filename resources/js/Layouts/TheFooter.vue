<template>
    ...
    <div class="max-w-screen-xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-x-8">
        <div>
        <img class="h-8" :src="route('root')+'/images/ajiriwa-new-logo.png'" alt="UptimeMate logo">
        ...
        <nav class="mt-4">
            ...
            <li>
                <a href="#" class="font-normal text-base hover:text-gray-200">Our Blog</a>
            </li>
            <li>
                <a href="#" class="font-normal text-base hover:text-gray-200">Privacy Policy</a>
            </li>
            </ul>
        </nav>
        </div>
        ...
        <div class="space-y-4 md:space-y-6 mt-4">
            <nav class="mt-4">
                <ul class="space-y-2">
                    <li>
                        <a href="#" class="font-normal text-base hover:text-gray-200">Find Jobs</a>
                    </li>
                    <li>
                        <a href="#" class="font-normal text-base hover:text-gray-200">Frequently Asked Questions</a>
                    </li>
                </ul>
            </nav>
